...
/// @title TokenA
/// @author Diego Sani
/// @notice Este contrato implementa un token ERC20 llamado TokenA con características mejoradas de seguridad
/// @dev Hereda de ERC20, Ownable, Pausable y ReentrancyGuard de OpenZeppelin
contract TokenA is ERC20, Ownable, Pausable, ReentrancyGuard {
    // Constantes
    ...
    constructor(  
    ) ERC20("TokenA", "TK-A") Ownable(msg.sender) {
        totalMinted = 0;
    }
